...
export default function WalletConnect({
  ...
  // Albedo manual address input state (hidden by default)
            ...
            {isModalOpen && (
              <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
                ...
                >
                  ...
                  {/* Optional Manual Entry Toggle Button */}
                  {!showAlbedoInput && (
                    <div className="text-center pt-2">
                      <button
                        onClick={() => setShowAlbedoInput(true)}
                        className="text-xs text-cyan-400 hover:text-cyan-300 font-bold hover:underline transition-colors"
                      >
                        Connect manually using Public Key instead
                      </button>
                    </div>
                  )}
                  ...
                  {showAlbedoInput && (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-purple-300">Paste Stellar Public Key:</span>
                        <a
